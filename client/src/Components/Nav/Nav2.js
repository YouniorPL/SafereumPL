  ...
  constructor(props) {
    ...
    this.state = {
      ...
      menuItems: [
        ...
        { key: 2, menuItem: 'PAYPAL', active: false, link: '/HowToBuy/#paypal' },
        { key: 3, menuItem: 'DIRECT DEPOSIT', active: false, link: '/HowToBuy/#direct' },
        { key: 4, menuItem: 'COINPAMENTS', active: false, link: '/HowToBuy/#coinpayments' },
