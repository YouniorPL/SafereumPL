    ...
    <div className="affiliate">
      ...
      <div className="container">
        <div className="affiliate_wrapper">
          ...
          <CategoryName
            title='How To Use'
            subtitle='BELOW INSTRUCTIONS WILL TEACH YOU HOW TO USE OUR AFFILIATE SYSTEM, READ THEM BEFORE ASKING QUESTIONS.' />
          ...
          <div className="affiliate_text">
            ...
            <p className="affiliate_second_p"><strong>2: </strong> CLICK ON THE ICON ASIDE OF YOUR NAME (TOP-RIGHT CORNER) THEN CLICK "REFERRAL" OR SIMPLY GO TO <strong>ICO.SAFEREUM.EU/USER/REFERRAL.</strong> </p>
              <p className="affiliate_second_p"><strong>3: </strong> AT REFERRAL PAGE YOU WILL FIND IMPORTANT INFORMATIONS ABOUT AFFILIATE SYSTEM AS WELL AS LIVE DATA OF YOUR REFERRALS.</p>
              ...
              <p className="affiliate_second_p"><strong>6: </strong> EVERY PURCHASE MADE BY YOUR FRIENDS WILL REWARD YOU WITH 20% COMMISION.</p>
              <p className="affiliate_second_p"><strong>7: </strong> YOUR FRIENDS WILL RECEIVE 5% BONUS ON EVERY PURCHASE AS WELL!</p>
              <p className="affiliate_second_p"><strong>8: </strong> REMEMBER THAT ONLY FIRST REWARD IS PAID INSTANTLY, AFTER FIRST REWARD YOU WILL RECEIVE PAYMENTS EVERY MONDAY.</p>
              <p className="affiliate_second_p"><strong>9: </strong> AFTER FIRST REWARD IS ASIGNED TO YOUR PROFILE, WE WILL CONTACT YOU VIA EMAIL, MAKE SURE YOU HAVE ACCESS TO YOUR CURRENT ADDRESS.</p>
