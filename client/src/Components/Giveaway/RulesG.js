    ...
    <div className="litepaper">
      ...
      <div className="container">
        <div className="litepaper_wrapper">
          ...
          <CategoryName
            title='RULES'
            subtitle='PLEASE READE BELOW RULES BEFORE PARTICIPATING, ALL RULE VIOLATIONS WILL RESULT IN CONSEQUENCES' />
          ...
          <div className="litepaper_text">
            ...
            <p className="litepaper_second_p"><strong>2: </strong> BELARUS AND RUSSIAN CITIZENS ARE RESTRICTED FROM PARTICIPATING.</p>
              ...
              <p className="litepaper_second_p"><strong>9: </strong> IF WINNER DOES NOT APPLY FOR REWARD WITHIN 14 DAYS COUNTING FROM THE DAY OF RAFFLE, NEW WINNER WILL BE PICKED.</p>
